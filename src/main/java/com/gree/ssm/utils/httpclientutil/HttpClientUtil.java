package com.gree.ssm.utils.httpclientutil;
...
import com.gree.ssm.utils.httpclientutil.common.HttpMethods;
import com.gree.ssm.utils.httpclientutil.common.Utils;
...
public class HttpClientUtil{
	 ...
	 *
	 * @param config		请求参数配置
	 * @return HttpResponse  返回响应结果
	 * @throws HttpProcessException
	 */
	public static HttpResponse postResponse(HttpConfig config) throws HttpProcessException {
		return sendResponse(config.method(HttpMethods.POST));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static HttpResponse sendResponse(HttpConfig config) throws HttpProcessException {
		return fmt3String(execute(config));
	}
	 ...
	 * @throws HttpProcessException
	 */
	private static HttpResponse fmt3String(HttpResponse resp) throws HttpProcessException {
		return resp;
	}
